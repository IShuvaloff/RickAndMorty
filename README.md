...
1. Перенести сортировку из HomeView в store, чтобы при перезагрузке списка достаточно было вызвать просто reload, а все операции с фильтрациями и сортировками производились на стороне хранилища автоматически;
